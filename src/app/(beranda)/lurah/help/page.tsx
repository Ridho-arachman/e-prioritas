  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-50 via-white to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Ringkasan peran perangkat desa */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
            <CardContent className="pt-6">
              ...
              <h3 className="font-semibold text-lg mb-2">Verifikasi Masukan</h3>
              <p className="text-sm text-slate-600">
                Periksa dan verifikasi masukan warga. Status dapat diubah
                menjadi DIVERIFIKASI, DITOLAK, atau dibiarkan MENUNGGU.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
            <CardContent className="pt-6">
              ...
              <h3 className="font-semibold text-lg mb-2">Kelola Data Master</h3>
              <p className="text-sm text-slate-600">
                Input dan kelola data master (indikator, kritikalitas) yang akan
                digunakan AI sebagai bobot penilaian.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-slate-600">
                Buat kegiatan rapat, jalankan AI untuk menghasilkan rekomendasi,
                lalu ajukan ke lurah untuk disetujui.
              </p>
            </CardContent>
          </Card>
        </div>

        {/* Diagram alur sederhana (disesuaikan untuk perangkat) */}
        ...
        <ClientOnly>
          <Accordion type="single" collapsible className="space-y-3 mb-10">
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 pt-2 space-y-4">
                <p className="text-slate-700">
                  Perangkat desa bertugas memverifikasi setiap masukan warga.
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="bg-purple-50 p-3 rounded-lg border border-purple-200 sm:col-span-2">
                    ...
                    <p className="text-sm mt-1">
                      (Otomatis) Rekomendasi terkait telah disetujui lurah.
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 pt-2 space-y-4">
                <p className="text-slate-700">
                  ...
                  mendapatkan 5 rekomendasi prioritas. Hasilnya akan tersimpan
                  sebagai <strong>DRAFT</strong>.
                </p>
            ...
            >
              <AccordionTrigger className="px-6 py-4 hover:bg-slate-50 hover:no-underline">
                <span className="flex items-center gap-3 text-lg font-medium">
                  ...
                  <span>5. Mengajukan Rekomendasi ke Lurah</span>
                </span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 pt-2 space-y-4">
                <p className="text-slate-700">
                  Setelah rekomendasi dihasilkan dan Anda yakin, ajukan kegiatan
                  tersebut ke lurah. Dengan mengklik tombol "Ajukan", status
                  kegiatan berubah dari <strong>DRAFT</strong> menjadi{" "}
                  <strong>DIAJUKAN</strong>. Lurah kemudian akan menyetujui atau
                  menolaknya.
                </p>
                <p className="text-sm text-slate-500 italic">
...
export default PerangkatHelpPage;
